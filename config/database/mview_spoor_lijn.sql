...
TABLESPACE pg_default AS
    SELECT "BGT_SPR_sneltram".identificatie_lokaalid,
    ...
    WHERE  1=1
UNION
    SELECT "BGT_SPR_tram".identificatie_lokaalid,
    ...
    WHERE 1=1
UNION
    SELECT "BGT_SPR_trein".identificatie_lokaalid,
...
/* KBK10 */
    SELECT "SBL_metro_overdekt".ogc_fid::character as identificatie_lokaalid,
    ...
    WHERE 1=1
UNION
    SELECT "SBL_trein_overdekt_1sp".ogc_fid::character as identificatie_lokaalid,
    ...
    WHERE 1=1
UNION
    SELECT "SBL_trein_overdekt_nsp".ogc_fid::character as identificatie_lokaalid,
...
UNION
    ...
    SELECT "SBL_metro_nietoverdekt_1sp".ogc_fid::character as identificatie_lokaalid,
...
UNION
    ...
    SELECT "SBL_metro_nietoverdekt_nsp".ogc_fid::character as identificatie_lokaalid,
...
UNION
    ...
    SELECT "SBL_trein_ongeelektrificeerd".ogc_fid::character as identificatie_lokaalid,
...
UNION
    ...
    SELECT "SBL_trein_nietoverdekt_1sp".ogc_fid::character as identificatie_lokaalid,
...
UNION
    ...
    SELECT "SBL_trein_nietoverdekt_nsp".ogc_fid::character as identificatie_lokaalid,
...
UNION
    ...
    SELECT "SBL_metro_sneltram_in_tunnel".ogc_fid::character as identificatie_lokaalid,
...
UNION
    ...
    SELECT "SBL_trein_in_tunnel".ogc_fid::character as identificatie_lokaalid,
...
UNION
    ...
    SELECT "SBL_metro_sneltram".ogc_fid::character as identificatie_lokaalid,
...
UNION
    ...
    SELECT "SBL_trein".ogc_fid::character as identificatie_lokaalid,
        'trein' as type,
        "SBL_trein".geom,
        NULL as relatievehoogteligging

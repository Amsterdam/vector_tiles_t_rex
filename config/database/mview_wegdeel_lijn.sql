...
/* --- KBK10 ---- */
    select
        ...
        'smalle_weg' as type,
        "WGL_smalle_weg".geom as geometrie,
...
UNION
    SELECT 
        ...
        "WGL_straat_in_tunnel".geom as geometrie, 
        0  as relatievehoogteligging, 
 	 	'kbk50' as bron, 
 	 	NULL::int  as minzoom, 
 	 	12 as maxzoom
...
UNION
    SELECT 
        ...
        "WGL_hoofdweg_in_tunnel".geom as geometrie,
        0  as relatievehoogteligging, 
 	 	'kbk50' as bron, 
 	 	NULL::int  as minzoom, 
 	 	12 as maxzoom
...
UNION
    SELECT 
        ...
        "WGL_regionale_weg_in_tunnel".geom as geometrie,
        0  as relatievehoogteligging, 
 	 	'kbk50' as bron, 
 	 	NULL::int  as minzoom, 
 	 	12  as maxzoom
...
UNION
    SELECT 
        ...
        "WGL_autosnelweg_in_tunnel".geom as geometrie,
        0  as relatievehoogteligging, 
 	 	'kbk50' as bron, 
 	 	NULL::int  as minzoom,
 	 	12  as maxzoom
...
UNION
    SELECT 
        ...
        'hoofdweg' as type,
        "WGL_hoofdweg".geom as geometrie,
        0  as relatievehoogteligging, 
 	 	'kbk50' as bron, 
 	 	NULL::int  as minzoom,
 	 	12  as maxzoom
...
UNION
    SELECT 
        ...
        'autosnelweg' as type,
        "WGL_autosnelweg".geom as geometrie,
        0  as relatievehoogteligging, 
 	 	'kbk50' as bron, 
 	 	NULL::int  as minzoom,
 	 	12  as maxzoom

...
AS SELECT "BGTPLUS_BAK_afvalbak".identificatie_lokaalid,
...
UNION
 SELECT "BGTPLUS_BAK_afval_apart_plaats".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_ISE_onbekend".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_ISE_pomp".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_KST_cai-kast".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_KST_elektrakast".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_KST_onbekend".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PAL_lichtmast".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PUT_brandkraan_-put".identificatie_lokaalid,
...
UNION
 SELECT "BGTPLUS_PUT_inspectie-_rioolput".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PUT_kolk".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SMR_abri".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SMR_betaalautomaat".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SMR_fietsenrek".identificatie_lokaalid,
...
UNION
 SELECT "BGTPLUS_SMR_herdenkingsmonument".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SMR_kunstobject".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SMR_openbaar_toilet".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SMR_reclamezuil".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SMR_telefooncel".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_VGT_boom".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGT_KDL_hoogspanningsmast_P".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_BRD_informatiebord".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_BRD_reclamebord".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_BRD_straatnaambord".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_BRD_verkeersbord".identificatie_lokaalid,
...
UNION
 SELECT "BGTPLUS_BRD_verklikker_transportleiding".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_BRD_wegwijzer".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_KST_gaskast".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_KST_gms_kast".identificatie_lokaalid,
...
UNION
 SELECT "BGTPLUS_KST_openbare_verlichtingkast".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_KST_rioolkast".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_KST_telecom_kast".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_KST_telkast".identificatie_lokaalid,
...
UNION
 SELECT "BGTPLUS_KST_verkeersregelinstallatiekast".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_MST_onbekend".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_MST_zendmast".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PAL_afsluitpaal".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PAL_drukknoppaal".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PAL_haltepaal".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PAL_hectometerpaal".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PAL_poller".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PAL_telpaal".identificatie_lokaalid,
...
UNION
 SELECT "BGTPLUS_PAL_verkeersregelinstallatiepaal".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PAL_vlaggenmast".identificatie_lokaalid,
...
UNION
 SELECT "BGTPLUS_PUT_benzine-_olieput".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PUT_drainageput".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PUT_gasput".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PUT_onbekend".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_PUT_waterleidingput".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SMR_bank".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SMR_brievenbus".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SMR_fietsenkluis".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SMR_lichtpunt".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SMR_slagboom".identificatie_lokaalid,
...
UNION
 SELECT "BGTPLUS_SMR_speelvoorziening".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SSR_camera".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SSR_flitser".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_SSR_waterstandmeter".identificatie_lokaalid,
  ...
  WHERE 1 = 1
UNION
 SELECT "BGTPLUS_WDI_meerpaal".identificatie_lokaalid,

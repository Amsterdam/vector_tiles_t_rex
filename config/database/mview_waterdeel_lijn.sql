...
AS SELECT "BGTPLUS_KDL_duiker_L".identificatie_lokaalid,
...
/* --- KBK50 ---- */
 ...
 UNION  
 SELECT "WDL_brede_waterloop".ogc_fid::character as identificatie_lokaalid,
 ...
 UNION  
 SELECT "WDL_smalle_waterloop".ogc_fid::character as identificatie_lokaalid,

...
AS SELECT "BGT_BTRN_boomteelt".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_BTRN_bouwland".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_BTRN_fruitteelt".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_BTRN_gemengd_bos".identificatie_lokaalid,
...
UNION
 SELECT "BGT_BTRN_grasland_overig".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_BTRN_groenvoorziening".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_BTRN_houtwal".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_BTRN_loofbos".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_BTRN_moeras".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_BTRN_naaldbos".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_BTRN_rietland".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_BTRN_struiken".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_KDL_perron".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_KDL_strekdam".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_OTRN_erf".identificatie_lokaalid,
...
UNION
 SELECT "BGT_OTRN_gesloten_verharding".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_OTRN_half_verhard".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_OTRN_onverhard".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_OTRN_open_verharding".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_OTRN_zand".identificatie_lokaalid,
...
UNION
 SELECT "BGT_OWDL_oever_slootkant".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_WGL_spoorbaan".identificatie_lokaalid,
  ...
  WHERE 1=1
UNION
 SELECT "BGT_BTRN_heide".identificatie_lokaalid,
